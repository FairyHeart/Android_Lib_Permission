 ...
 * @date  : 2020-04-01.
 */
enum class Permission(var value: String) {
    @Dynamic
    ACTIVITY_RECOGNITION_GROUP("android.permission-group.ACTIVITY_RECOGNITION"),
    @Dynamic
    CALENDAR_GROUP("android.permission-group.CALENDAR"),
    @Dynamic
    CALL_LOG_GROUP("android.permission-group.CALL_LOG"),
    @Dynamic
    CAMERA_GROUP("android.permission-group.CAMERA"),
    @Dynamic
    CONTACTS_GROUP("android.permission-group.CONTACTS"),
    @Dynamic
    LOCATION_GROUP("android.permission-group.LOCATION"),
    @Dynamic
    MICROPHONE_GROUP("android.permission-group.MICROPHONE"),
    @Dynamic
    PHONE_GROUP("android.permission-group.PHONE"),
    @Dynamic
    SENSORS_GROUP("android.permission-group.SENSORS"),
    @Dynamic
    SMS_GROUP("android.permission-group.SMS"),
    @Dynamic
